...
public class LineVelocityAverageResource extends CoapResource{
	...
	public LineVelocityAverageResource(String name, MonilineGateway monilineGateway, String lineID) {
	...
	**/
	private void jsonDatataFormatting() {
		...
		Gson lineVelocityAverageSerialize = gsonBuilder.enableComplexMapKeySerialization().create();	
		
		this.measures = lineVelocityAverageSerialize.toJson(this.monilineGateway.getLineVelocityAverage());
		
		System.out.print("Chaimata get risorsa velocità media linea: " + this.measures);
